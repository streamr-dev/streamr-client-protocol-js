...
```
[version, type, streamId, streamPartition, requestId, fromMsgRef, toMsgRef, publisherId, sessionToken]
```
Example:
```
[1, 13, "streamId", 0, "requestId", [...fromMsgRefFields], [...toMsgRefFields], "publisherId", "my-session-token"]
```
