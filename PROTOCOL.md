...
`streamPartition` | Integer | Partition id of the messages to resend. Optional, defaults to 0.
...
```
[version, type, streamId, streamPartition, subId, fromMsgRef, publisherId]
```
Example:
```
[1, 12, "streamId", 0, "subId", [...msgRefFields], "publisherId"]
```
...
`publisherId` | String | The publisher id of the messages to resend. Can be `"*"` to resend the messages of all publishers.
...
```
[version, type, streamId, streamPartition, subId, fromMsgRef, toMsgRef, publisherId]
```
Example:
```
[1, 13, "streamId", 0, "subId", [...fromMsgRefFields], [...toMsgRefFields], "publisherId"]
```
