...
describe('ResendRangeRequestV1', () => {
    ...
    describe('serialize', () => {
        it('correctly serializes messages', () => {
            const arr = [1, 13, 'streamId', 0, 'subId', [132846894, 0], [132847000, 0], 'publisherId']
            const serialized = new ResendRangeRequestV1('streamId', 0, 'subId', [132846894, 0], [132847000, 0], 'publisherId').serialize()
