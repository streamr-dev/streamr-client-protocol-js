...
describe('UnsubscribeRequestSerializerV1', () => {
    describe('deserialize', () => {
        it('correctly parses messages', () => {
            ...
            const result = new UnsubscribeRequestSerializerV1(...arr)
    ...
    describe('serialize', () => {
        it('correctly serializes messages', () => {
            ...
            const serialized = new UnsubscribeRequestSerializerV1('streamId', 0).serialize()
        ...
        it('correctly serializes messages to version 0', () => {
            ...
            const serialized = new UnsubscribeRequestSerializerV1('streamId', 0).serialize(0)
            assert(typeof serialized === 'string')
