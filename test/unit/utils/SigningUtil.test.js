...
import { hash, sign, recover } from '../../../src/utils/SigningUtil'
...
describe('SigningUtil', () => {
    describe('hash', () => {
        it('produces correct hashes', () => {
            ...
            const correctHash = '93a27d93e7e894f5434596428181f5b58c3759ec861400a539125320d86cef6e'
            assert.strictEqual(hash(payload).toString('hex'), correctHash)
        })
    })
